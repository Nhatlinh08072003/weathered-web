  ...
  return (
    <div className="bg-white text-white min-h-screen flex flex-col">
      <main className="flex-grow flex items-center justify-center text-center gap-5">
        <div className="pl-10">
          <h1 className="text-3xl text-black text-center items-center  font-bold mb-4 pr-4">WELCOME TO REVERSIBLE</h1>
          <p className="mb-10 text-black text-center items-center  max-w-xl text-sm">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <div className=" p-4 rounded-lg text-center w-[45%] relative">
            ...
            <h2 className="text-lg font-semibold absolute inset-0 flex items-center justify-center text-white">SHOP WOMENSWEAR</h2>
          </div>

          {/* MENSWEAR */}
          <div className=" p-4 rounded-lg text-center  w-[45%] relative">
            <img src="/images/men.jpg" alt="Menswear" className="rounded-lg mb-4 w-full h-auto object-cover" />
            <h2 className="text-lg font-semibold absolute inset-0 flex items-center justify-center text-white">SHOP MENSWEAR</h2>
          </div>
        </div>
      </main>
    </div>
